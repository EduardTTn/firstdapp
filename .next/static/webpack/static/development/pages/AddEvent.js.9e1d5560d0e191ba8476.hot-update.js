          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                if (_this.state.month > 12 || _this.state.day < 1) {
                  _this.setState({
                    errorMessage: "Invalid month"
                  });
                }

                if (!(_this.state.year > 2040 || _this.state.day < 2019)) {
                  _context.next = 7;
                  break;
                }
...
//# sourceMappingURL=AddEvent.js.9e1d5560d0e191ba8476.hot-update.js.map